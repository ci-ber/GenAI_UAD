    ...
    def train(self, model_state=None, opt_state=None, start_epoch=0):
        ...
        for epoch in range(self.training_params['nr_epochs']):
            ...
            for data in self.train_ds:
                ...
                loss_q = f_result['quantization_losses']
                loss = loss_rec + loss_q
                ...
                batch_loss_q += loss_q.item() * images.size(0)

            epoch_loss = batch_loss / count_images if count_images > 0 else batch_loss
            epoch_loss_q = batch_loss_q / count_images if count_images > 0 else batch_loss_q
            epoch_losses.append(epoch_loss)
            epoch_losses_q.append(epoch_loss_q)
            ...
            wandb.log({"Train/Loss_Q_": epoch_loss_q, '_step_': epoch})
